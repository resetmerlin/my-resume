...
- **마진 거래 백오피스 개발**: 2024년 10월 31일 마진거래 서비스 런칭 이전까지 전체 마진 거래 백오피스 화면 중 63%를 구현. <br/> (프론트 2명, 서버 3명, PM 2명)
...
1. 서비스 핵심 기능 로깅 시스템 구축  
   ...
   - 성과 (2): 즉 지표를 통해 문제점을 좁힐 수 있었고 개선을 하여 초기 베타 런칭 Retention을 3% 대비 정식 런칭 후 15%로 개선할 수 있었음.
...
2. 개발 환경 분리 및 테스트,QA 환경 개선
    ...
    - 성과: 안정적인 개발·운영  QA 효율 프로세스를 확보하고, 전체 방문자의 41%를 차지하는 모바일 유저의 서비스 참여율을 향상시킴  
